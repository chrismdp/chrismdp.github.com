...
excerpt: "AI rollouts fail by default. Who in your company owns the AI workflows people have already built, and who fixes them when the model changes or the person who made them leaves? This session is about the part of an AI rollout that never gets budgeted: the engineers who turn prototypes into workflows that last."

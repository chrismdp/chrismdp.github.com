...
{% include inline-image.html src="/assets/img/human-in-the-loop-department.jpg" alt="Human In The Loop Department comic: three tired staff behind a desk, one pressing a worn YES button while the NO button gathers cobwebs. Caption: when the job title said rapid decision making, this wasn't what Richard had in mind." align="center" width="75%" caption="A weak approval ritual is not safer than a well-scoped permission system." %}

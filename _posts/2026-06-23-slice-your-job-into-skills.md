...
The argument has just picked up some official backing. In June 2026 OpenAI's own economists mapped how AI is likely to reshape Europe's workforce, and the telling thing is what they declined to do: they did not sort job titles into safe and doomed, but sorted work into four kinds of change happening at once - occupations that may grow, ones facing higher near-term automation, a large group likely to reorganise, and a majority facing little immediate change.[^eumap] The public conversation still wants to fight about whole job titles. The more useful map, drawn by the company building the tools, is that different slices of the same role change in different ways, and a single department usually holds all four of those futures at once.

The Times story gives the factory-floor version of the same lesson: Ford deployed 900 AI-powered cameras and automated design tools to improve vehicle quality, then rehired 350 veteran technicians when the systems lacked the institutional knowledge, troubleshooting intuition, and practical experience needed to fix quality at source.[^ford] Charles Poon, Ford's vice-president of vehicle hardware engineering, put it plainly: "Mistakenly, we thought that by just introducing artificial intelligence and adjusting the design requirements that we had, that that would produce a high-quality product." That is the danger of treating a visible task as the whole job. The camera may spot a defect, but the expert knows why the defect keeps happening, which exceptions matter, how to teach the next person, and what good looks like before the tool has enough examples to copy.
...
[^eumap]: OpenAI Economic Research, [*Mapping Europe's AI Workforce Opportunity*](https://openai.com/index/mapping-ai-jobs-transition-eu){:target="_blank"}, 29 June 2026, which extends its earlier US [AI Jobs Transition Framework](https://cdn.openai.com/pdf/the-ai-jobs-transition-framework-for-the-eu.pdf){:target="_blank"} to the EU using the official ESCO occupational taxonomy and Eurostat employment data. In its split of EU employment, about 12 percent of work is in occupations that may grow with AI, about 14 percent has higher near-term automation potential, about 27 percent is likely to reorganise, and about 47 percent faces less immediate change. OpenAI is explicit that this is a planning map, not a set of employment forecasts, and notes the EU has a smaller share of high-automation occupations than the US.

[^ford]: Mark Sellman, [*Ford rehires 'greybeards' after AI tech fails to deliver*](https://www.thetimes.com/article/7b9223e1-232e-4cfa-8fac-cbc57d277954?shareToken=90cfb1aee3016b53729c8c536e8bb348){:target="_blank"}, *The Times*, 29 June 2026. Ford reportedly deployed 900 AI-powered cameras across its plants and automated design tools, then rehired 350 veteran technicians to train younger workers and the AI systems after finding that institutional knowledge and troubleshooting intuition had not transferred cleanly into the tools.

...
{% include testimonial.html style="bordered" name="Mark Jaggers" role="Lead Development Engineer, Instem" image="" linkedin="" quote="I've done what was scheduled to be a month and a half's worth of work in three days. It's worked extremely well." %}
...
{% include testimonial.html style="bordered" name="Colby Dilks" role="Principal AI Product Engineer, Instem" image="colby-dilks.jpg" linkedin="https://www.linkedin.com/in/colbydilks/" quote="Transformative, because it transforms everything that I do as an engineer leading teams. It's not just writing the code; it's transformed the way I think about testing, architecture, managing a team, DevOps, and documentation. Everything's become possible and easier to do now, and it unlocks the ability to think in new ways. There's not really a blocker to what you can do apart from your own mindset." %}
...
<div class="bg-white rounded-lg p-8 text-center mt-12 border border-brand-light-blue/20">
  ...
  <p class="text-brand-black/80 mb-6">Get AI training and coaching built around your team's real work. Fill in the form to get started:</p>

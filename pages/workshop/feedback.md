...
<div class="bg-brand-white rounded-lg p-8 border border-brand-light-blue/20 mb-12">
  <p class="text-lg text-brand-black/80 mb-6 text-center">
    Thanks so much for attending the workshop! Please <strong>take a few moments</strong> to answer a few follow-up questions.
  </p>

  <div class="rm-area-workshop-feedback"></div>
</div>
